...
export const productData = {
  ...
  shortDescription:
    "A bright Moroccan-inspired salad with colour and aroma that retains freshness for 2–3 days chilled. Great for patient or staff Grab & Go.",
  ingredients: [
    "300g couscous",
  ...
  photo: "/images/moroccan-couscous-sweet-potato.webp",
  thumbnail: "/images/moroccan-couscous-sweet-potato-thumb.webp",
  unitCost: "",
  unitSellingPrice: "",
  allergens: [
...
export default function MoroccanCouscousAndSweetPotatoGrabAndGoSaladSheet({
  product = productData,
  updateProduct,
}) {
  return (
